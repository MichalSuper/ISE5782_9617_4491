...
public class ReflectionRefractionTests {
	...
	public void twoSpheres() {
		...
		scene.lights.add( //
				new SpotLight(new Color(1000, 600, 0),
						new Point(-100, -100, 500), new Vector(-1, -1, -2)) //
	...
	public void twoSpheresOnMirrors() {
		...
		scene.getGeometries().add( //
				...
				new Triangle(new Point(1500, -1500, -1500),
						new Point(-1500, 1500, -1500), new Point(670, 670, 3000)) //
						.setEmission(new Color(20, 20, 20)) //
						.setMaterial(new Material().setKr(1)),
				new Triangle(new Point(1500, -1500, -1500),
						new Point(-1500, 1500, -1500),	new Point(-1500, -1500, -2000)) //
						.setEmission(new Color(20, 20, 20)) //
	...
	public void trianglesTransparentSphere() {
		...
		scene.getGeometries().add( //
				new Triangle(new Point(-150, -150, -115),
						new Point(150, -150, -135), new Point(75, 75, -150)) //
	...
	public void allFeature(){
		...
		Scene scen = new Scene.SceneBuilder("Test scene")
				...
				.setBackground(new Color(94,97,99)).build();
		...
		ImageWriter imageWriter = new ImageWriter("allFeature", 700, 700);
		camera.setImageWriter(imageWriter) //
